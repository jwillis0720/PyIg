...
nucleotide = [
    {'default': 0, 'formal': 'Framework 1 Nuc.', 'json_key': 'regions.fw0'},
    {'default': 0, 'formal': 'Framework 2 Nuc.', 'json_key': 'regions.fw2'},
    {'default': 0, 'formal': 'Framework 3 Nuc.', 'json_key': 'regions.fw3'},
    {'default': 0, 'formal': 'Framework 4 Nuc.', 'json_key': 'regions.fw4'},
    {'default': 0, 'formal': 'CDR1 Nuc.', 'json_key': 'regions.cdr1'},
    {'default': 0, 'formal': 'CDR2 Nuc.', 'json_key': 'regions.cdr2'},
    {'default': 0, 'formal': 'CDR3 Nuc.', 'json_key': 'regions.cdr3'}]

amino = [
    {'default': 0, 'formal': 'Framework 1 AA', 'json_key': 'regions_aa.fw0_aa'},
    {'default': 0, 'formal': 'Framework 2 AA', 'json_key': 'regions_aa.fw2_aa'},
    {'default': 0, 'formal': 'Framework 3 AA', 'json_key': 'regions_aa.fw3_aa'},
    {'default': 0, 'formal': 'Framework 4 AA', 'json_key': 'regions_aa.fw4_aa'},
    {'default': 0, 'formal': 'Framework 1 AA Length', 'json_key': 'fw0_aa_length'},
    {'default': 0, 'formal': 'Framework 2 AA Length', 'json_key': 'fw2_aa_length'},
    {'default': 0, 'formal': 'Framework 3 AA Length', 'json_key': 'fw3_aa_length'},
    {'default': 0, 'formal': 'Framework 4 AA Length', 'json_key': 'fw4_aa_length'},
    {'default': 0, 'formal': 'CDR1 AA', 'json_key': 'regions_aa.cdr1_aa'},
    {'default': 0, 'formal': 'CDR2 AA', 'json_key': 'regions_aa.cdr2_aa'},
    {'default': 0, 'formal': 'CDR3 AA', 'json_key': 'regions_aa.cdr3_aa'},
    {'default': 0, 'formal': 'CDR1 AA Length', 'json_key': 'cdr1_aa_length'},
    {'default': 0, 'formal': 'CDR2 AA Length', 'json_key': 'cdr2_aa_length'},
    {'default': 0, 'formal': 'CDR3 AA Length', 'json_key': 'cdr3_aa_length'}
]

total_alignments = [
    {'default': 0, 'formal': 'Total Alignment Matches', 'json_key': 'total_align.matches'},
    {'default': 0, 'formal': 'Total Alignment Mismatches', 'json_key': 'total_align.mismatches'},
    {'default': 0, 'formal': 'Total Alignment Length', 'json_key': 'total_align.length'},
    {'default': 0, 'formal': 'Total Alignment Gaps', 'json_key': 'total_align.gaps'},
    {'default': 0, 'formal': 'Total Alignment Percent Identity', 'json_key': 'total_align.percent_identity'}
]
...
v_hits = [
    {'default': 0, 'formal': 'V-Gene', 'json_key': 'v_hits.rank_0.subject_id'},
    {'default': 0, 'formal': 'V-Gene Mismatches', 'json_key': 'v_hits.rank_0.mismatches'},
    {'default': 0, 'formal': 'V-Gene Percent Identity', 'json_key': 'v_hits.rank_0.percent_identity'},
    {'default': 0, 'formal': 'V-Gene Percent Gaps', 'json_key': 'v_hits.rank_0.gaps'},
    {'default': 0, 'formal': 'V-Gene Percent e-Value', 'json_key': 'v_hits.rank_0.evalue'},
    {'default': 0, 'formal': 'V-Gene Percent Bit Score', 'json_key': 'v_hits.rank_0.bit_score'},
    {'default': 0, 'formal': 'V-Gene Percent Alignment Length', 'json_key': 'v_hits.rank_0.alignment_length'}
]

d_hits = [
    {'default': 0, 'formal': 'D-Gene', 'json_key': 'd_hits.rank_0.subject_id'},
    {'default': 0, 'formal': 'D-Gene Mismatches', 'json_key': 'd_hits.rank_0.mismatches'},
    {'default': 0, 'formal': 'D-Gene Percent Identity', 'json_key': 'd_hits.rank_0.percent_identity'},
    {'default': 0, 'formal': 'D-Gene Percent Gaps', 'json_key': 'd_hits.rank_0.gaps'},
    {'default': 0, 'formal': 'D-Gene Percent e-Value', 'json_key': 'd_hits.rank_0.evalue'},
    {'default': 0, 'formal': 'D-Gene Percent Bit Score', 'json_key': 'd_hits.rank_0.bit_score'},
    {'default': 0, 'formal': 'D-Gene Percent Alignment Length', 'json_key': 'd_hits.rank_0.alignment_length'}
]

j_hits = [
    {'default': 0, 'formal': 'J-Gene', 'json_key': 'j_hits.rank_0.subject_id'},
    {'default': 0, 'formal': 'J-Gene Mismatches', 'json_key': 'j_hits.rank_0.mismatches'},
    {'default': 0, 'formal': 'J-Gene Percent Identity', 'json_key': 'j_hits.rank_0.percent_identity'},
    {'default': 0, 'formal': 'J-Gene Percent Gaps', 'json_key': 'j_hits.rank_0.gaps'},
    {'default': 0, 'formal': 'J-Gene Percent e-Value', 'json_key': 'j_hits.rank_0.evalue'},
    {'default': 0, 'formal': 'J-Gene Percent Bit Score', 'json_key': 'j_hits.rank_0.bit_score'},
