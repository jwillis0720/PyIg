...
# help="The auxilariay path that contains the frame origins of the
# germline genes for each repertoire.\n Helps produce translation and
# other metrics")
...
#             default=cpu_count(),
# help="How many do you want to split the job across, default is the
...
# help="Open this file and comment out options you don't want in your
# final file.\nThe first column is the name of the option.\nThe second
# column is used by the parser and should not be changed.")
...
# help="Turn off automatic concatenation and deletion of temporary
# files.\nFiles are split up at the beginning to run across multiple
# processors")

#         formatter.add_argument(
#             "-j", "--json", action="store_true", default=False,
# help="Use the JSON output option that will format the text driven
# igblast output to a json document.\nDefaults to CSV")
...
# help="Open this file and comment out the final options you don't want in
# your final file.\nThe first column is the name of the option.\nThe
# second column is used by the parser and should not be changed.")
...
# return os.path.join(self.args.db_path, self.args.type,
# self.args.organism, common_prefix + vdj)
